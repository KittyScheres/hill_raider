...
namespace HillRaider
{
	...
	static std::list<Entity*> GetEnemyList() {
		...
		default:
			return std::list<Entity*>{ new EnemyAnt((64 * 5) + 32, (64 * 7) + 32), new EnemyAnt((64 * 13) + 32, 64 + 32) };
		}
	}
	...
	static std::list<Entity*> GetPointsPickupList() {
		...
		{
		case 0:
			return std::list<Entity*>{ new FoodPointsPickup(20, (64 * 12) + 32, (64 * 6) + 32), new FoodPointsPickup(20, 64 + 32, 64 + 32), new FoodPointsPickup(20, (64 * 3) + 32, (64 * 5) + 32) };

		case 1:
		case 2:
			return std::list<Entity*>{ new FoodPointsPickup(20, (64 * 8) + 32, (64 * 4) + 32), new FoodPointsPickup(20, (64 * 9) + 32, (64 * 7) + 32) };

		default:
			return std::list<Entity*>{ new FoodPointsPickup(20, (64 * 3) + 32, (64 * 4) + 32) };
		}
	}

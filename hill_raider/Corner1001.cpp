...
namespace HillRaider
{
	...
	static std::list<Entity*> GetEnemyList() {
		switch (std::rand() & 1) {
		case 0:
			return std::list<Entity*>{ new EnemyAnt((64 * 5) + 32, 64 + 32), new EnemyAnt((64 * 13) + 32, (64 * 7) + 32) };
	...
	static std::list<Entity*> GetPointsPickupList() {
		...
		{
		case 0:
			return std::list<Entity*>{ new FoodPointsPickup(20, (64 * 3) + 32, (64 * 3) + 32), new FoodPointsPickup(20, (64 * 13) + 32, 64 + 32), new FoodPointsPickup(20, (64 * 9) + 32, (64 * 7) + 32) };

		case 1:
		case 2:
			return std::list<Entity*>{ new FoodPointsPickup(20, (64 * 9) + 32, (64 * 2) + 32), new FoodPointsPickup(20, (64 * 13) + 32, (64 * 4) + 32) };

		default:
			return std::list<Entity*>{ new FoodPointsPickup(20, (64 * 3) + 32, (64 * 2) + 32) };
		}
	}

...
namespace HillRaider
{
	static char tilemap[9][46]{
		...
		"beaca ca ca ca ca edxdaxebxca ca ca ca ca adx",
		"bcxca eaxddxca ca ca ca ca ca ca eaxddxca adx",
		"bcxca dbxdexca ca ca ca ca ca ca dbxdexca adx",
		"bcxca ca ca ca ca ca ca ca ca ca ca ca ca adx",
	...
	TSplit1011::TSplit1011() : Room(new TileMap("assets/environments/tile_map.png", tilemap, 64, 64), GetEnemyList(), GetPointsPickupList()) {}

	TSplit1011::~TSplit1011() {}
}